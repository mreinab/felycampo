/* Datos de los 3 ateliers/showroom — ver ListadoUbicaciones.jsx.
   "ciudad" alimenta los chips de filtro (Salamanca/Madrid/Oviedo) ahí
   mismo — mismo orden que este array (Salamanca antes tenía dos
   tarjetas, novias y fiesta, fusionadas en una sola "Atelier
   Salamanca"). Sin imagen propia por sede: la galería de cada tarjeta
   sale del fondo común de public/img/talleres/ (ver MEDIOS_TALLERES en
...
export const UBICACIONES = [
  {
    id: 'salamanca',
    ciudad: 'Salamanca',
    nombre: 'Atelier Salamanca',
    direccion: ['C/ Laguna Negra 17-19', '37008 Salamanca'],
    telefonos: ['+34 923 000 000', '+34 616 356 217'],
    whatsapp: '+34 616 356 217',
    horario: { es: 'Lun - Vie: 09:30 - 17:30', en: 'Mon - Fri: 9:30am - 5:30pm' },
    descripcion: {
      es: 'Espacio dedicado a la novia y a nuestras colecciones de fiesta, además de contar con una sección de nuestra línea pret-a-porter.',
      en: 'Bridal and eveningwear atelier: fittings, pattern-making, made-to-measure gowns and statement pieces for special occasions.',
    },
  },
  {
    id: 'madrid',
