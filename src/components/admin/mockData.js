...
// Looks de "Furisode" (cat35, Fiesta) — a diferencia de looksLaColeccion,
// aquí sí hay datos reales por look (SKU de prendas + tags de estilo, del
// lote de fotos entregado), no solo imágenes; colores/telas/descripción
// quedan para más adelante igual que el resto de colecciones de archivo.
// `tags` no tiene columna propia todavía en la vista de looks
// (ListaProductos.jsx solo pinta Look/SKU/Imágenes/Descripción) pero se
// guarda igualmente para no perder el dato de origen.
// Huecos de imágenes frente al recuento entregado (look 19 ya resuelto,
// subidas sus 2 fotos): look 14 trae 2 fotos (se esperaban 3), look 28
// trae 2 fotos (se esperaba 1) y look 29 trae 1 foto (se esperaban 2) —
// diferencias menores de recuento, sin importancia; se deja constancia
// aquí en vez de forzar un número que no existe en disco.
const RUTA_FURISODE = '/img/collections/fiesta/furisode';
const looksFurisode = [
  { nombre: 'Furisode Fiesta 1', prendas: [{ nombre: '', sku: '18101 V' }], tags: ['Colección', 'Diferente', 'Fiesta', 'Furisode', 'Mangas', 'Midi', 'Mikado', 'Recto', 'Volumen'], imagenes: [`${RUTA_FURISODE}/022coleccionesfiesta-furisodefiesta-look1-felycampo2-1.webp`, `${RUTA_FURISODE}/023coleccionesfiesta-furisodefiesta-look1-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 2', prendas: [{ nombre: '', sku: '18102 F' }, { nombre: '', sku: '18103 T' }], tags: ['Colección', 'Diferente', 'Dos piezas', 'Escote Espalda', 'Fiesta', 'Furisode', 'Largo', 'Sirena'], imagenes: [`${RUTA_FURISODE}/043coleccionesfiesta-furisodefiesta-look2-felycampo2-1.webp`, `${RUTA_FURISODE}/044coleccionesfiesta-furisodefiesta-look2-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 3', prendas: [{ nombre: '', sku: '18104 V' }], tags: ['Clásico', 'Colección', 'Escote Espalda', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Volumen'], imagenes: [`${RUTA_FURISODE}/050coleccionesfiesta-furisodefiesta-look3-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 4', prendas: [{ nombre: '', sku: '18105' }], tags: ['Clásico', 'Colección', 'Corto', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Recto'], imagenes: [`${RUTA_FURISODE}/052coleccionesfiesta-furisodefiesta-look4-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 5', prendas: [{ nombre: '', sku: '18106 V' }], tags: ['Colección', 'Diferente', 'Fiesta', 'Furisode', 'Mangas', 'Midi', 'Recto'], imagenes: [`${RUTA_FURISODE}/053coleccionesfiesta-furisodefiesta-look5-felycampo2-1.webp`, `${RUTA_FURISODE}/054coleccionesfiesta-furisodefiesta-look5-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 6', prendas: [{ nombre: '', sku: '18107 V' }], tags: ['Alfombra roja', 'Colección', 'Diferente', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Mangas', 'Recto'], imagenes: [`${RUTA_FURISODE}/055coleccionesfiesta-furisodefiesta-look6-felycampo2-1.webp`, `${RUTA_FURISODE}/056coleccionesfiesta-furisodefiesta-look6-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 7', prendas: [{ nombre: '', sku: '18108 V' }], tags: ['Colección', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Lencero', 'Recto'], imagenes: [`${RUTA_FURISODE}/057coleccionesfiesta-furisodefiesta-look7-felycampo2-1.webp`, `${RUTA_FURISODE}/058coleccionesfiesta-furisodefiesta-look7-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 8', prendas: [{ nombre: '', sku: '18109 V' }], tags: ['Alfombra roja', 'Asimétrico', 'Colección', 'Corto', 'Diferente', 'Escote Espalda', 'Fiesta', 'Furisode', 'Largo', 'Noche', 'Volumen'], imagenes: [`${RUTA_FURISODE}/059coleccionesfiesta-furisodefiesta-look8-felycampo2-1.webp`, `${RUTA_FURISODE}/060coleccionesfiesta-furisodefiesta-look8-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 9', prendas: [{ nombre: '', sku: '18110 V' }], tags: ['Alfombra roja', 'Colección', 'Diferente', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Noche', 'Recto', 'Sirena'], imagenes: [`${RUTA_FURISODE}/061coleccionesfiesta-furisodefiesta-look9-felycampo2-1.webp`, `${RUTA_FURISODE}/062coleccionesfiesta-furisodefiesta-look9-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 10', prendas: [{ nombre: '', sku: '18111 V' }, { nombre: '', sku: '18112 T' }], tags: ['Colección', 'Dos piezas', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Minimal', 'Noche', 'Sirena'], imagenes: [`${RUTA_FURISODE}/001coleccionesfiesta-furisodefiesta-look10-felycampo2.webp`, `${RUTA_FURISODE}/002coleccionesfiesta-furisodefiesta-look10-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 11', prendas: [{ nombre: '', sku: '18114 T' }, { nombre: '', sku: '18115 F' }], tags: ['Colección', 'Diferente', 'Dos piezas', 'Fiesta', 'Furisode', 'Midi', 'Noche', 'Volumen'], imagenes: [`${RUTA_FURISODE}/003coleccionesfiesta-furisodefiesta-look11-felycampo2.webp`, `${RUTA_FURISODE}/004coleccionesfiesta-furisodefiesta-look11-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 12', prendas: [{ nombre: '', sku: '18116 T' }, { nombre: '', sku: '18117 F' }], tags: ['Alfombra roja', 'Colección', 'Diferente', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Noche', 'Sirena'], imagenes: [`${RUTA_FURISODE}/005coleccionesfiesta-furisodefiesta-look12-felycampo2-1.webp`, `${RUTA_FURISODE}/006coleccionesfiesta-furisodefiesta-look12-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 13', prendas: [{ nombre: '', sku: '18118 V' }], tags: ['Colección', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Mangas', 'Minimal', 'Noche', 'Recto'], imagenes: [`${RUTA_FURISODE}/007coleccionesfiesta-furisodefiesta-look13-felycampo2-1.webp`, `${RUTA_FURISODE}/008coleccionesfiesta-furisodefiesta-look13-felycampo3-1.webp`, `${RUTA_FURISODE}/009coleccionesfiesta-furisodefiesta-look13-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 14', prendas: [{ nombre: '', sku: '18119 V' }], tags: ['Colección', 'Diferente', 'Fiesta', 'Furisode', 'Midi', 'Volumen'], imagenes: [`${RUTA_FURISODE}/010coleccionesfiesta-furisodefiesta-look14-felycampo2-1.webp`, `${RUTA_FURISODE}/011coleccionesfiesta-furisodefiesta-look14-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 15', prendas: [{ nombre: '', sku: '18120 F' }, { nombre: '', sku: '18121 T' }], tags: ['Colección', 'Diferente', 'Dos piezas', 'Fiesta', 'Furisode', 'Midi', 'Volumen'], imagenes: [`${RUTA_FURISODE}/012coleccionesfiesta-furisodefiesta-look15-felycampo2-1.webp`, `${RUTA_FURISODE}/013coleccionesfiesta-furisodefiesta-look15-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 16', prendas: [{ nombre: '', sku: '18125 V' }], tags: ['Alfombra roja', 'Colección', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Minimal', 'Noche', 'Sirena'], imagenes: [`${RUTA_FURISODE}/014coleccionesfiesta-furisodefiesta-look16-felycampo2-1.webp`, `${RUTA_FURISODE}/015coleccionesfiesta-furisodefiesta-look16-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 17', prendas: [{ nombre: '', sku: '18126 V' }], tags: ['Colección', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Lencero', 'Noche', 'Recto'], imagenes: [`${RUTA_FURISODE}/016coleccionesfiesta-furisodefiesta-look17-felycampo2-1.webp`, `${RUTA_FURISODE}/017coleccionesfiesta-furisodefiesta-look17-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 18', prendas: [{ nombre: '', sku: '18129 V' }], tags: ['Asimétrico', 'Colección', 'Diferente', 'Escote Espalda', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Volumen'], imagenes: [`${RUTA_FURISODE}/018coleccionesfiesta-furisodefiesta-look18-felycampo2-1.webp`, `${RUTA_FURISODE}/019coleccionesfiesta-furisodefiesta-look18-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 19', prendas: [{ nombre: '', sku: '18130 V' }], tags: ['Clásico', 'Colección', 'Corto', 'Fiesta', 'Furisode', 'Mangas', 'Mikado', 'Recto'], imagenes: [`${RUTA_FURISODE}/020coleccionesfiesta-furisodefiesta-look19-felycampo2-1.webp`, `${RUTA_FURISODE}/021coleccionesfiesta-furisodefiesta-look19-felycampo-1 (1).webp`] },
  { nombre: 'Furisode Fiesta 20', prendas: [{ nombre: '', sku: '18131 V' }], tags: ['Clásico', 'Colección', 'Fiesta', 'Furisode', 'Mangas', 'Midi', 'Mikado', 'Recto'], imagenes: [`${RUTA_FURISODE}/024coleccionesfiesta-furisodefiesta-look20-felycampo2.webp`, `${RUTA_FURISODE}/025coleccionesfiesta-furisodefiesta-look20-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 21', prendas: [{ nombre: '', sku: '18132 V' }], tags: ['Clásico', 'Colección', 'Escote Espalda', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Volumen'], imagenes: [`${RUTA_FURISODE}/026coleccionesfiesta-furisodefiesta-look21-felycampo2.webp`, `${RUTA_FURISODE}/027coleccionesfiesta-furisodefiesta-look21-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 22', prendas: [{ nombre: '', sku: '18133 V' }, { nombre: '', sku: '18134 T' }], tags: ['Clásico', 'Colección', 'Corto', 'Dos piezas', 'Escote Espalda', 'Fiesta', 'Furisode', 'Minimal', 'Recto'], imagenes: [`${RUTA_FURISODE}/028coleccionesfiesta-furisodefiesta-look22-felycampo2.webp`, `${RUTA_FURISODE}/029coleccionesfiesta-furisodefiesta-look22-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 23', prendas: [{ nombre: '', sku: '18136 V' }], tags: ['Asimétrico', 'Colección', 'Corto', 'Diferente', 'Escote Espalda', 'Fiesta', 'Furisode', 'Mangas', 'Recto', 'Volumen'], imagenes: [`${RUTA_FURISODE}/030coleccionesfiesta-furisodefiesta-look23-felycampo2.webp`, `${RUTA_FURISODE}/031coleccionesfiesta-furisodefiesta-look23-felycampo.webp`] },
  { nombre: 'Furisode Fiesta 24', prendas: [{ nombre: '', sku: '18137 V' }], tags: ['Alfombra roja', 'Clásico', 'Colección', 'Escote Espalda', 'Fiesta', 'Fluido', 'Furisode', 'Largo', 'Noche', 'Sirena'], imagenes: [`${RUTA_FURISODE}/032coleccionesfiesta-furisodefiesta-look24-felycampo2-1.webp`, `${RUTA_FURISODE}/033coleccionesfiesta-furisodefiesta-look24-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 25', prendas: [{ nombre: '', sku: '18138 T' }, { nombre: '', sku: '18139 F' }], tags: ['Colección', 'Diferente', 'Dos piezas', 'Fiesta', 'Furisode', 'Largo', 'Mikado', 'Noche', 'Volumen'], imagenes: [`${RUTA_FURISODE}/034coleccionesfiesta-furisodefiesta-look25-felycampo2-1.webp`, `${RUTA_FURISODE}/035coleccionesfiesta-furisodefiesta-look25-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 26', prendas: [{ nombre: '', sku: '18140 V' }], tags: ['Colección', 'Corte A', 'Diferente', 'Escote Espalda', 'Fiesta', 'Furisode', 'Midi'], imagenes: [`${RUTA_FURISODE}/036coleccionesfiesta-furisodefiesta-look26-felycampo2-1.webp`, `${RUTA_FURISODE}/037coleccionesfiesta-furisodefiesta-look26-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 27', prendas: [{ nombre: '', sku: '18141 V' }], tags: ['Clásico', 'Colección', 'Corto', 'Fiesta', 'Furisode', 'Recto'], imagenes: [`${RUTA_FURISODE}/038coleccionesfiesta-furisodefiesta-look27-felycampo2-1.webp`, `${RUTA_FURISODE}/039coleccionesfiesta-furisodefiesta-look27-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 28', prendas: [{ nombre: '', sku: '18145 V' }], tags: ['Asimétrico', 'Clásico', 'Colección', 'Corte A', 'Corto', 'Fiesta', 'Furisode', 'Largo', 'Mangas', 'Mikado'], imagenes: [`${RUTA_FURISODE}/040coleccionesfiesta-furisodefiesta-look28-felycampo2-1.webp`, `${RUTA_FURISODE}/041coleccionesfiesta-furisodefiesta-look28-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 29', prendas: [{ nombre: '', sku: '18146 V' }], tags: ['Clásico', 'Colección', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Recto'], imagenes: [`${RUTA_FURISODE}/042coleccionesfiesta-furisodefiesta-look29-felycampo-1.webp`] },
  { nombre: 'Furisode Fiesta 30', prendas: [{ nombre: '', sku: '18147 V' }], tags: ['Asimétrico', 'Colección', 'Corte A', 'Diferente', 'Escote Espalda', 'Fiesta', 'Furisode', 'Midi', 'Mikado', 'Minimal', 'Volumen'], imagenes: [`${RUTA_FURISODE}/045coleccionesfiesta-furisodefiesta-look30-felycampo2-1.webp`, `${RUTA_FURISODE}/046coleccionesfiesta-furisodefiesta-look30-felycampo-1.webp`] },
