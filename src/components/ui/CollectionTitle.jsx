...
/**
 * Cabecera de colección: etiqueta + título + descripción opcional,
 * todo centrado. No recibe los textos directamente sino sus claves de
 * traducción (messages/{locale}.json) — así el mismo componente sirve
 * para distintas colecciones sin hardcodear nada aquí.
 * Uso:
 *   <CollectionTitle
